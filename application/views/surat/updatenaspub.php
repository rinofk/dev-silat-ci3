        ...
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?= form_open_multipart('surat/do_updatenaspub/'.$np['id_naspub']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="judul_naspub" class="form-control" id="judul_naspub"><?= $np['judul_naspub']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="abstrack" class="form-control" id="abstrack"><?= $np['abstrack']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pembimbing" class="col-sm-3 col-form-label">Pembimbing Utama</label>
                        <div class="col-sm-9"> 
                            <input type="text" name="pembimbing" class="form-control" id="pembimbing" value="<?= $np['pembimbing']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nip" class="col-sm-3 col-form-label">NIP/ NIDK</label>
                        <div class="col-sm-9"> <input type="text" name="nip" class="form-control" id="nip" value="<?= $np['nip']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9"> <input type="text" name="ket" class="form-control" id="ket" value="<?= $np['ket']; ?>">
                        </div>
                    </div>
