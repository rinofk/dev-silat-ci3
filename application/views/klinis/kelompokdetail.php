...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Kelompok Mahasiswa Aktif | <?= $pk['nama_klinik']; ?> | Periode : <?= $pk['tgl_mulai']; ?> s/d <?= $pk['tgl_selesai']; ?> | Stase : <?= $pk['nama_stase']; ?></h6>
        </div>
        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kd as $s) { ?>
                                            <tr>
                                                ...
                                                <td><?= $s['admin']; ?></td>
                                                <td><?= $s['date_create']; ?></td>
                                                <td><a href="<?= base_url(); ?>klinis/hapus_mahasiswa/<?= $s['id_kelompok']; ?>" class="badge badge-danger float-right" onclick="return confirm('Apakah Anda yakin <?= $s['nim_mahasiswa']; ?> [-<?= $s['nama_lengkap']; ?>-] data ini di HAPUS');">Hapus</a></td>
...
<div class="modal fade" id="newMahasiswaModal<?= $id_praktekklinik; ?>" tabindex="-1" role="dialog" aria-labelledby="newMahasiswaModalLabel" aria-hidden="true">
            ...
            <form action="<?= base_url('klinis/kelompokdetailtambah'); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_praktekklinik" name="id_praktekklinik" placeholder="ID Praktek Klinik" value="<?= $id_praktekklinik; ?>">
                    </div>
                </div>
                <div class="modal-body">
                    <div class="form-group">
