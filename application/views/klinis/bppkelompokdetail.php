    ...
    <div class="row mt-3">
        <div class="col-xl-4">
            <div class="card shadow mb-8">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Upload Kwitansi Pembayaran</h6>
                </div>
                <div class="card-body">
                    <?= form_open_multipart('klinikbpp/kwitansi_update/' . $pk['id_praktekklinik']); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="kwitansi" name="kwitansi" aria-describedby="inputGroupFileAddon04">
                                            <label class="custom-file-label" for="kwitansi"><?= $pk['kwitansi']; ?></label>
                                        </div>
                                        <div class="input-group-append">
                                            <a href="<?= base_url(); ?>assets/klinis/kwitansi/<?= $pk['kwitansi']; ?>" target="_blank" class="btn btn-outline-secondary">
                                                Preview
                                            </a>
                                        </div>
                                    </div>
