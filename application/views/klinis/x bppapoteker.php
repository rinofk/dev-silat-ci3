...
<div class="container-fluid">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="<?= base_url(); ?>klinikbpp/ners">Penagihan Baru Profesi Ners</a></div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Praktek Klinik Aktif Profesi Apoteker</h6>
        </div>
        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($pkd as $s) { ?>
                                            <tr>
                                                ...
                                                <td><?= $s['admin']; ?></td>
                                                <td><a href="" class="badge badge-primary float-right" data-toggle="modal" data-target="#newUpdateModal<?= $s['id_praktekklinik']; ?>">Update ID-<?= $s['id_praktekklinik']; ?></a><br><small><?= $s['date_update']; ?></small></td>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Riwayat Praktek Klinik Profesi Apoteker</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($pkds as $s) { ?>
                                            <tr>
                                                ...
                                                <td><a href="" class="badge badge-primary float-right" data-toggle="modal" data-target="#newUpdateLunasModal<?= $s['id_praktekklinik']; ?>">Update ID-<?= $s['id_praktekklinik']; ?></a><br><small><?= $s['date_update']; ?></small></td>
                                            </tr>
                                        <?php $i++;
                                        }
                                        ?>
    ...
    <div class="modal fade" id="newUpdateModal<?= $s['id_praktekklinik']; ?>" tabindex="-1" role="dialog" aria-labelledby="newUpdateModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('klinikbpp/apoteker'); ?>" method="post">
