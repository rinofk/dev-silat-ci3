                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tgl_lahir" class="form-control datepicker" id="tgl_lahir" value="<?= $mahasiswa['tgl_lahir']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="agamaa" class="col-sm-3 col-form-label">Agamaa</label>
                            <div class="col-sm-9">
                                <input type="text" name="agamaa" class="form-control" id="agamaa" value="<?= $mahasiswa['agamaa']; ?>">
                            </div>
                        </div>
                        ...
                        <a href="<?= base_url(); ?>mahasiswa/detail/<?= $mahasiswa['nim']; ?>" class="btn btn-primary"><i class="fas fa-fw fa-arrow-left"></i>Kembali</a>
                        <button type="submit" name="ubah" class="btn btn-primary float-right"><i class="far fa-fw fa-edit"></i> SAVE</button>
                        <!--<button type="submit" name="ubahotomatis" class="btn btn-primary"><i class="far fa-fw fa-edit"></i>Auto Kapital</button>-->
