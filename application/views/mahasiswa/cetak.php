...
$html .= '<tr><td width=200>Nama Lengkap   </td><td width=3>:</td><td colspan="2">' . $mahasiswa["nama_lengkap"] . ' </td></tr>';
$html .= '<tr><td>Tempat/ Tanggal Lahir   </td><td>:</td><td colspan="2">' . $mahasiswa["tempat_lahir"] . ', ' .  $mahasiswa["tgl_lahir"] . ' </td></tr>';
$html .= '<tr><td>Nim            </td><td>:</td><td colspan="2">' . $mahasiswa["nim"] . '          </td></tr>';
$html .= '<tr><td>Semester / Prodi      </td><td>:</td><td colspan="2">' . $mahasiswa["semester"] . ' / ' . $mahasiswa["nama_prodi"] . '   </td></tr>';
$html .= '<tr><td>Tahun Ajaran   </td><td>:</td><td colspan="2">' . $mahasiswa["tahun_ajaran"] . '       </td></tr>';
$html .= '<tr><td>Nama Orang Tua </td><td>:</td><td colspan="2">' . $mahasiswa["ortu"] . '       </td></tr>';
$html .= '<tr><td>NIP/NRP/NPS    </td><td>:</td><td colspan="2">' . $mahasiswa["nip"] . '       </td></tr>';
$html .= '<tr><td>Pangkat/Golongan</td><td>:</td><td colspan="2">' . $mahasiswa["pangkat"] . '       </td></tr>';
$html .= '<tr><td>Instansi         </td><td>:</td><td colspan="2">' . $mahasiswa["instansi"] . '       </td></tr>';
$html .= '<tr><td>Alamat         </td><td>:</td><td colspan="2">' . $mahasiswa["alamat"] . '       </td></tr>';
