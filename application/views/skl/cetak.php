...
// $pdf->SetFont('arial', '', $kop['size_u']);
// $pdf->Cell($margin_kop, 5, '', 0, 0);
// $pdf->Cell(160, 5, $kop['universitas'], 0, 1, 'C');

// $pdf->Cell(10, 1, '', 0, 1);

// $pdf->SetFont('arial', 'B', $kop['size_f']);
// $pdf->Cell($margin_kop, 5, '', 0, 0);
// $pdf->Cell(160, 5, $kop['fakultas'], 0, 1, 'C');

// $pdf->Cell(10, 1, '', 0, 1);

// $pdf->SetFont('arial', '', $kop['size_j']);
// $pdf->Cell($margin_kop, 5, '', 0, 0);
// $pdf->Cell(160, 5, $kop['jalan'], 0, 1, 'C');
...
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(45, 5, 'Tanggal Lulus', 0, 0);
$pdf->Cell(5, 5, ':', 0, 0);
$pdf->Cell(115, 5,  tgl_ind(date($surat['tgl_lulus_sidang'])), 0, 1);

$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(45, 5, 'IPK', 0, 0);
$pdf->Cell(5, 5, ':', 0, 0);
$pdf->Cell(115, 5,  $surat['ipk'], 0, 1);

$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(45, 5, 'Predikat Kelulusan', 0, 0);
$pdf->Cell(5, 5, ':', 0, 0);
