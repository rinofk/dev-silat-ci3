        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Bebas Lab Prodi Profesi Dokter</h6>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-10">
                                    <a href="<?= base_url(); ?>laboran/profesidokter" class="btn btn-primary"><i class="fas fa-fw fa-arrow-left"></i>Kembali</a>
...
<div class="modal fade" id="newRoleModal" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('laboran/profesidokterreject/' . $bl['id_bebaslab']); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
