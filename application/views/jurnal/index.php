                                ...
                                <table class="table" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($naspub as $s) { ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td><a href="<?= base_url(); ?>jurnal/detail/<?= $s['id_naspub']; ?>"><?= $s['nim']; ?> [-<?= $s['id_naspub']; ?>-]</a></td>
                                                <td><?= $s['nama_lengkap']; ?></td>
                                                <td><?= $s['pembimbing']; ?></td>
                                                <td><?= $s['nama_prodi']; ?></td>
                                                <td><?= $s['judul_naspub']; ?><br><?= $s['ket']; ?></td>
                                                <td><?= date('d/m/y', $s['date_create']); ?></td>
                                                <td> <?php
                                                            ...
                                                            <?php
                                                            if ($s['status'] == 'selesai') {; ?>
                                                                <?= $s['status']; ?><br><?= date('d/m/y',$s['date_finish']); ?>
                                                            <?php }; ?>
                                                    <!--<?= $s['status']; ?> <?= date('d F Y', $user['date_created']); ?>-->
                                                    </td>
                                            </tr>
                                        <?php $i++;
                                        }
