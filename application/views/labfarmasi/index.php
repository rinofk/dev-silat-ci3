...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berkasi Bebas Lab Prodi Farmasi belum Valid</h6>
        </div>
        <div class="card-body">
                                ...
                                <table class="table" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($bl as $s) { ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td><a href="<?= base_url(); ?>Laboran/farmasidetail/<?= $s['id_bebaslab']; ?>"><?= $s['nim_mahasiswa']; ?> [-<?= $s['id_bebaslab']; ?>-]</a></td>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berkas Bebas Lab Farmasi yang telah Valid</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
