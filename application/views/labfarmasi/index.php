...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berkas Bebas Lab Prodi S1 Farmasi</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($bl as $s): ?>
                            <tr>
                                <th scope="row"><?= $i++; ?></th>
                                <td>
                                    <a href="<?= base_url("Laboran/farmasidetail/{$s['id_bebaslab']}"); ?>">
                                ...
                                <td><?= $s['status']; ?><br><?= $s['keterangan']; ?></td>
                                <td>
                                    <?= $s['date_updated']; ?><br>
                                    <?= $s['lab1_admin']; ?><br>

                                    <?php if (strtolower($s['status']) !== 'accept'): ?>
                                        <a href="<?= base_url("laboran/hapus_farmasi/{$s['id_bebaslab']}"); ?>" 
