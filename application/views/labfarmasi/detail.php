        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Berkas Lab Farmasi <strong>berhasil</strong> <?= $this->session->flashdata('flash'); ?>.
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Bebas Lab Prodi Farmasi</h6>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-10">
                                    <a href="<?= base_url(); ?>laboran/farmasi" class="btn btn-primary"><i class="fas fa-fw fa-arrow-left"></i>Kembali</a>
                                    ...
                                    if ($bl['status'] == 'di ajukan') {; ?>
                                        <a href="<?= base_url(); ?>laboran/farmasiproses/<?= $bl['id_bebaslab']; ?>" class="btn btn-outline-primary" target="blank"> Proses </a>
                                    <?php } else {; ?>
                                        <a href="<?= base_url(); ?>laboran/farmasicetak/<?= $bl['id_bebaslab']; ?>" class="btn btn-outline-primary" target="blank"> Cetak </a>
                                    <?php }; ?>
                                </div>
                            </div>
                            </form>
...
<div class="modal fade" id="newRoleModalAccept" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('laboran/farmasiaccept/' . $bl['id_bebaslab']); ?>" method="post">
...
<div class="modal fade" id="newRoleModal" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('laboran/farmasireject/' . $bl['id_bebaslab']); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
