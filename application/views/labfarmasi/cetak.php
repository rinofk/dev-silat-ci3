...
$pdf->Image('assets/img/pejabat/wahyudi.png', 40, 170, 10, 28);
$pdf->Image('assets/img/pejabat/caturiani.png', 120, 175, 49, 15);
$pdf->Image('assets/img/pejabat/cap.png', 15, 165, 33, 32);
...
$pdf->Cell(60, 5, '', 0, 1, 'L');
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(105, 5, 'Ketua TIM Bidang Akademik', 0, 0);
$pdf->Cell(60, 5, 'Koordinator Laboran', 0, 1);
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(105, 5, 'dan Kemahasiswaan', 0, 0);
$pdf->Cell(60, 5, '', 0, 1);
...
$pdf->Cell(60, 5, 'Nama Koordinator', 0, 1);
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(105, 5, 'NIP. 197509232006041001', 0, 0);
$pdf->Cell(60, 5, 'NIP. xxxxx', 0, 1);
