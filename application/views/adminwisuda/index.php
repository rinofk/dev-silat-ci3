...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berkasi Wisuda yang belum Valid</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="DataTables_length" id="dataTable_length">
                                <table class="table" id="datatable">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php foreach ($wisuda as $s) { ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td><a href="<?= base_url(); ?>adminwisuda/detail/<?= $s['id_bw']; ?>"><?= $s['nim_bw']; ?> [-<?= $s['id_bw']; ?>-]</a></td>
                                                <td><?= $s['nama_lengkap']; ?></td>
                                                <td><?= $s['nama_prodi']; ?></td>
                                                <td><?= date('d F Y', $s['date_created']); ?></td>
                                                <td><?= $s['status']; ?></td>
                                                <td><?= date('d F Y', $s['date_updated']); ?></td>
                                            </tr>
                                        <?php $i++;
                                        }
                                        ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berkas Wisuda Mahasiswa yang telah Valid</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <table class="table" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($status as $st) { ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td><a href="<?= base_url(); ?>adminwisuda/detail/<?= $st['id_bw']; ?>"><?= $st['nim_bw']; ?> [-<?= $st['id_bw']; ?>-]</a></td>
                                                <td><?= $st['nama_lengkap']; ?></td>
                                                <td><?= $st['nama_prodi']; ?></td>
                                                <td><?= date('d F Y', $st['date_created']); ?></td>
                                                <td><?= $st['status']; ?></td>
                                                <td><?= date('d F Y', $st['date_updated']); ?></td>
                                            </tr>
                                        <?php $i++;
                                        }
                                        ?>
