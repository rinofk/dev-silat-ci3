...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <p> - Setelah surat diajukan diharapkan untuk konfirmasi kembali ke admin melalui wa sebelah ini agar bisa di proses lebih lanjut, Hubungi Admin <a href="https://wa.me/6285252161577?text=Hai%20Admin%20Aplikasi%20Surat%20SKL, " rel="nofollow" target="_blank"><i class="fab fa-whatsapp"></i> Yasinta Pagi</a></p>
        ...
        <?php } else {; ?>
            ...
            <?php
            if (empty($status_skl['id_skl'])) {; ?>
                <div class="container">
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <a href="<?= base_url(); ?>alumni/skltambah/<?= $user['nim']; ?>" type="button" class="btn btn-outline-primary mb-3">Ajukan Surat</a>
                        </div>
                    </div>
                </div>
            <?php } else {; ?>
                                        ...
                                        <div class="DataTables_length" id="dataTable_length">
                                            ...
                                            <table class="table" id="datatable">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">NIM</th>
                                                        <th scope="col">Tanggal Lulus Sidang</th>
                                                        <th scope="col">IPK</th>
