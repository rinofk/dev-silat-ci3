...
$pdf->Cell(120, 6, '', 0, 0);
$pdf->Cell(60, 6, 'Pontianak, ' . tgl_ind(date($skl['date_create'])), 0, 1, 'R');

$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(85, 5, 'Perihal : Permohonan Surat Keterangan Kelulusan', 0, 1);
...
$pdf->Cell(3, 6, ':', 0, 0);
$pdf->MultiCell(117, 6, $skl['tempat_lahir'] . ', ' .  tgl_ind(date($skl['tgl_lahir'])), 0, 'J');


$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(40, 6, 'Alamat', 0, 0);
$pdf->Cell(3, 6, ':', 0, 0);
$pdf->MultiCell(117, 6, $skl['alamat_sekarang'], 0, 'J');
...
$pdf->Cell(3, 6, ':', 0, 0);
$pdf->MultiCell(117, 6,  tgl_ind(date($skl['tgl_lulus_sidang'])), 0, 'J');
