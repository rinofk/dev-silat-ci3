        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Surat Keterangan Lulus Yudisium
                </div>
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tgl_lulus" class="form-control datepicker" id="tgl_lulus" value="<?= $alumni['tgl_lulus_yudisium']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-9"> <input type="text" name="predikat" class="form-control" id="predikat" value="<?= $skl['predikat']; ?>"></div>
                        </div> -->
