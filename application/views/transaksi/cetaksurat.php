...
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6, ucwords(strtolower(htmlspecialchars($surat['nama_lengkap']))), 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Tempat/ Tanggal Lahir', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6, ucwords(strtolower(htmlspecialchars($surat['tempat_lahir']))) . ', ' .  tgl_ind(date($surat['tgl_lahir'])), 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'NIM', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6,  $surat['nim'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Semester/ Prodi', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6,  $surat['semester'] . ' / ' . $surat['nama_prodi'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Tahun Ajaran', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6, $surat['tahun_ajaran'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Nama Orang Tua', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6,  $surat['ortu'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'NIP/NRP/NPS', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6,  $surat['nip'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Pangkat/ Golongan', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6, $surat['pangkat'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Instansi', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->Cell(106, 6,  $surat['instansi'], 0, 1);

$pdf->Cell($margin_kiri, 6, '', 0, 0);
$pdf->Cell(50, 6, 'Alamat Instansi', 0, 0);
$pdf->Cell(4, 6, ':', 0, 0);
$pdf->MultiCell(106, 6,  $surat['alamat_instansi'], 0, 'J');
