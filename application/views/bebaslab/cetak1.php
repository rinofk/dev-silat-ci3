...
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->MultiCell($width_cell, 5, 'Bahwa yang bersangkutan dinyatakan Bebas dari segala Administrasi Peminjaman Lab non mikroskopik, Lab mikroskopik, dan Lab keterampilan klinis dasar Fakultas Kedokteran Universitas Tanjungpura Pontianak', 0, 'J');
...
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(105, 5, '', 0, 0);
$pdf->Cell(60, 5, 'Prodi Kedokteran', 0, 1);
...
$pdf->Cell(60, 5, 'Sumo Lestari, S.T', 0, 1);
$pdf->Cell($margin_kiri, 5, '', 0, 0);
$pdf->Cell(105, 5, 'NIP. 197509232006041001', 0, 0);
$pdf->Cell(60, 5, 'NIP. 197804182008012020', 0, 1);
